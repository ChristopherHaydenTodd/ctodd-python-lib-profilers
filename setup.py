...
def main():
    ...
    setup(
        name="ctodd-python-lib-profilers",
        version=version,
        python_requires=">3.0,<3.7",
        description=("Python utilities used for Profiling Python Code"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-profilers",
        author="Christopher H. Todd",
        author_email="Christopher.Hayden.Todd@gmail.com",
        classifiers=["Programming Language :: Python"],
        keywords=["python", "libraries", "profiling", "profilers", "optimization"],
        packages=packages,
